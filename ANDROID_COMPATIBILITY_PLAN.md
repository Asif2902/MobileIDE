...
| OpenCode Android command | **1.18.23 HOST/ABI VERIFIED — DEVICE RETEST** | `ad38ea4` | OpenCode 1.18.23 and matching OpenTUI 0.4.5 are rebuilt from exact upstream commits for Android/Bionic ARM64. The graph is PIE/16-KiB aligned and the renderer exports all 342 required symbols. The previous 1.17.9 payload passed version/help/debug/run/serve/web, TUI, spinner, and Bash-tool checks on API 30; the upgraded payload requires its phone retest. API 29/36 and x86_64 payload coverage remain. |
